...
export default function Calendar() {
    ...
    <div class="flex items-center justify-center py-8 px-4">
        <div class="max-w-sm w-full rounded-md shadow-lg md:p-8 p-5 bg-white dark:bg-gray-800">
            <div class="px-4 flex items-center justify-between leading-8">
                <a tabindex="0" role="link"
                    class="cursor-pointer focus:text-gray-400 hover:text-gray-400 text-base font-medium text-gray-800 dark:text-gray-100">October
                    2020</a>
